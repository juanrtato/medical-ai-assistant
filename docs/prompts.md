# Documentación de Prompts del Sistema

Este documento describe los prompts y directrices del sistema utilizadas por el asistente de **Emermédica AI**.

---

## 1. Prompt Principal del Agente (`SYSTEM_PROMPT`)

**Ubicación**: `backend/app/assistant/prompts.py`
...
## 2. Prompt para Clasificación de Triage (`TRIAGE_PROMPT`)
...
## 3. Prompt para Generación de Atención Médica (`ATTENTION_PROMPT`)
...
## 4. Prompt del Parser de Estado de Entrevista (`parse_response`)

**Ubicación**: `backend/app/assistant/parser.py`
